...
import survivalblock.enchancement_unbound.common.entity.goal.SentientPantsAttackGoal;
import survivalblock.enchancement_unbound.common.entity.goal.SentientPantsFollowGoal;
import survivalblock.enchancement_unbound.common.entity.goal.SentientPantsTrackingGoal;
...
public class SentientPantsEntity extends PathAwareEntity implements Ownable {
    ...
    public Box getBoundingBox(EntityPose pose) {
        return this.isInSneakingPose() ? NULL_BOX : super.getBoundingBox(pose);
    }
