...
import survivalblock.enchancement_unbound.common.item.UnboundDebugItem;
...
public class UnboundItems {
    ...
    public static final Item UNBOUND_DEBUG_ITEM = registerItem("unbound_debug_item", new UnboundDebugItem(new FabricItemSettings().rarity(Rarity.EPIC).maxCount(1)), null);
