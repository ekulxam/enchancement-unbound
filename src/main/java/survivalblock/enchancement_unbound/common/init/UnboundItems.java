...
public class UnboundItems {
    ...
    public static final Item ORBITAL_STRIKE_BRIMSTONE = registerItem("orbital_strike_brimstone", new OrbitalStrikeBrimstoneItem(new FabricItemSettings().rarity(Rarity.EPIC).maxCount(1)), null);
    ...
    // public static final Item UNBOUND_DEBUG_ITEM = registerItem("unbound_debug_item", new UnboundDebugItem(new FabricItemSettings().rarity(Rarity.EPIC).maxCount(1)), ItemGroups.OPERATOR);
