...
public class UnboundItems {
    ...
    public static final Item ORBITAL_STRIKE_BRIMSTONE = registerItem("orbital_strike_brimstone", new OrbitalStrikeBrimstoneItem(new Item.Settings().rarity(Rarity.EPIC).maxCount(1)), ItemGroups.COMBAT);
    public static final Item ICE_SHARD_MINIGUN = registerItem("ice_shard_minigun", new ShardMinigunItem(new Item.Settings().rarity(Rarity.EPIC).maxCount(1), Items.BLUE_ICE), ItemGroups.COMBAT);
    public static final Item AMETHYST_SHARD_MINIGUN = registerItem("amethyst_shard_minigun", new ShardMinigunItem(new Item.Settings().rarity(Rarity.EPIC).maxCount(1), Items.AMETHYST_SHARD), ItemGroups.COMBAT);
    public static final Item SLINGSHOT = registerItem("slingshot", new UnboundSlingshotItem(new Item.Settings().rarity(Rarity.RARE).maxCount(1)), null);
