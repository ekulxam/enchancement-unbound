package survivalblock.enchancement_unbound.mixin.vanillachanges.correctenchantmenttarget;
...
public class EnchantmentHelperMixin {
    ...
    private static boolean returnCorrectForShieldEnchantments(EnchantmentTarget instance, Item item, Operation<Boolean> original, int power, ItemStack stack, @Local Enchantment enchantment){
        if (enchantment instanceof UnboundShieldEnchantment || enchantment == UnboundEnchantments.CURTAIN) {
