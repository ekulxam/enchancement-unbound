...
Enchancement Unbound's versions will be put into this format:</br>
**a.b.c+w.x-y+z</br>**
...
- Sentient Pants : Attacks the owner's targets and attackers. If a player owns this pair of pants, they can right-click the pants with an empty hand to get the leggings back. The pants will always drop its leggings upon death. The pants' health and max health is determined by the item's durability. If the pants' item is immune to fire, the pants themselves will be immune to fire. The pants will take the name of the leggings that spawned them.
...
- Ascension : Shovel enchantment, idea by @duriangape on Discord. Inspired by the Ascend ability from Zelda: Tears of the Kingdom. Allows the user to phase through blocks upward when clicking on the bottom face of a block.
...
- Midas Touch : Sword/Axe/Pickaxe/Shovel/Hoe curse, suggested by @opixeel on Discord. Inspired by the Greek myth of King Midas in which he gains the ability to turn anything to gold. This curse turns entities into gold upon hit. Fails in the nether. Deactivates if the entity is touching rain, water, or a bubble column, if the entity has extended water (the amphibious effect that allows you to riptide out of water), is frozen (from frostbite), or has been golden for 10 minutes. Stronger Entities will break free much faster. Only works on gold or netherite tools.
...
- Slamming On Pointed Dripstone Instakills : Self-explanatory. [Default = true, My Recommendation = false]
